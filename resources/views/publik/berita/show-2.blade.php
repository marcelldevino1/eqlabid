...
<head>
  ...
  <title>Pembagian Sembako | EQLAB.id</title>
  ...
  <section class="min-h-screen py-12 lg:py-20">
    <div class="container max-w-6xl px-6 mx-auto sm:px-8">
      <nav class="mb-10 text-sm font-medium text-gray-500">
        ...
        <span class="mx-2 text-gray-400">/</span>
        <span class="text-[#0C3C6C] font-semibold">Pembagian Sembako</span>
      </nav>
      ...
      <div class="flex flex-col items-center gap-10 lg:flex-row lg:items-start">
        ...
        <div class="w-full lg:w-1/2">
          ...
          <p class="leading-relaxed text-gray-700">
            Dalam rangka membantu masyarakat yang membutuhkan, para relawan Tzu Chi membagikan sembako kepada warga sekitar dengan penuh kasih dan kepedulian. Kegiatan ini menjadi wujud nyata cinta kasih tanpa pamrih dalam menghadapi tantangan ekonomi masyarakat.
          </p>
        </div>
      </div>
    </div>
