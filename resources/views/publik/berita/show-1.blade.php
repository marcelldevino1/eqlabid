...
<head>
  ...
  <title>Pengesahan Tzu Chi Hospital | EQLAB.id</title>
  ...
  <section class="min-h-screen py-12 lg:py-20">
    <div class="container max-w-6xl px-6 mx-auto sm:px-8">
      ...
      <nav class="mb-10 text-sm font-medium text-gray-500">
        ...
        <span class="mx-2 text-gray-400">/</span>
        <span class="text-[#0C3C6C] font-semibold">Pengesahan Tzu Chi Hospital</span>
      </nav>
      ...
      <div class="flex flex-col items-center gap-10 lg:flex-row lg:items-start">
        ...
        <div class="w-full lg:w-1/2">
          ...
          <p class="leading-relaxed text-gray-700">
            Presiden Joko Widodo bersama perwakilan Yayasan Buddha Tzu Chi meresmikan Tzu Chi Hospital yang menjadi simbol kolaborasi kemanusiaan dan pelayanan kesehatan unggul di Indonesia. Rumah sakit ini diharapkan menjadi pusat pelayanan medis berlandaskan cinta kasih universal.
          </p>
        </div>
      </div>
    </div>
