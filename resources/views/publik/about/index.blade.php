<section class="px-6 py-20 bg-white sm:px-10 lg:px-24" id="about">
    <div class="container mx-auto text-center">
        ...
        <!-- Judul -->
        <h2 class="mb-5 text-4xl font-semibold text-[#0C3C6C]" data-anim="rise" data-delay="80">
            Apa itu EQLAB.ID?
        </h2>

        <!-- Deskripsi -->
        <p class="max-w-3xl mx-auto text-lg text-gray-700 sm:text-xl" data-anim="rise" data-delay="160">
        ...
        <a href="{{ route('about') }}"
            ...
            data-anim="rise cta-glow" data-delay="260">
            Lihat Lebih Lengkap
        ...
        <div class="grid grid-cols-1 gap-6 mt-10 sm:grid-cols-2 lg:grid-cols-3 lg:items-center"
            data-anim-group="about-cards">
            <!-- 1 -->
            <div class="relative order-1 p-6 text-center transition bg-white border border-gray-100 shadow-md rounded-2xl hover:shadow-lg lg:order-1"
                data-anim="rise" data-delay="320">
            ...
            <!-- 2 -->
            <div class="relative order-3 p-6 text-center transition bg-white border border-gray-100 shadow-md rounded-2xl hover:shadow-lg lg:order-4"
                data-anim="rise" data-delay="380">
                <div class="flex flex-col items-center">
                    <div
                        class="flex items-center justify-center w-14 h-14 mb-3 text-white bg-[#0C3C6C] rounded-xl shadow-md">
            ...
            <!-- 3 -->
            <div class="relative order-3 p-6 text-center transition bg-white border border-gray-100 shadow-md rounded-2xl hover:shadow-lg lg:order-3"
                data-anim="rise" data-delay="440">
                <div class="flex flex-col items-center">
                    <div
                        class="flex items-center justify-center w-14 h-14 mb-3 text-white bg-[#0C3C6C] rounded-xl shadow-md">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
            ...
            <!-- 4 -->
            <div class="relative order-4 p-6 text-left transition bg-white border border-gray-100 shadow-md rounded-2xl hover:shadow-lg lg:order-6"
                data-anim="rise" data-delay="500">
                ...
                <h3 class="mb-2 text-xl font-bold text-center text-[#0C3C6C]">Akses 24/7</h3>
            ...
            <!-- 5 (kartu tengah tinggi) -->
            <div class="relative flex flex-col justify-center order-5 p-6 text-left transition bg-white border border-gray-100 shadow-md rounded-2xl hover:shadow-xl sm:col-span-2 lg:col-span-1 lg:row-span-2 lg:order-2"
                data-anim="rise" data-delay="560">
                <div class="space-y-4">
                    <div class="flex items-center justify-center">
                        <div
                            class="flex items-center justify-center w-14 h-14 mb-3 mr-4 text-white bg-[#0C3C6C] rounded-xl shadow-md">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="2" aria-hidden="true">
                                <circle cx="12" cy="12" r="10"></circle>
                        ...
                        <span
                            class="absolute flex items-center justify-center w-6 h-6 text-xs font-semibold text-white bg-gray-500 rounded-full shadow-sm top-3 right-4">5</span>
                    </div>
                    <div>
                        <h3 class="mb-2 text-lg font-extrabold text-[#0C3C6C] sm:text-xl">Efisiensi Tinggi</h3>
