...
<head>
  ...
  <title>Juara 2 Lomba Menyanyi | EQLAB.id</title>
  ...
  <section class="min-h-screen py-12 lg:py-20">
    <div class="container max-w-6xl px-6 mx-auto sm:px-8">
      ...
      <nav class="mb-10 text-sm font-medium text-gray-500">
        ...
        <span class="mx-2 text-gray-400">/</span>
        <span class="text-[#0C3C6C] font-semibold">Juara 2 Lomba Menyanyi</span>
      </nav>
      ...
      <div class="flex flex-col items-center gap-10 lg:flex-row lg:items-start">
        ...
        <div class="w-full lg:w-1/2">
          <h1 class="mb-3 text-3xl font-extrabold text-[#0C3C6C] sm:text-4xl">
            Juara 2 Lomba Menyanyi Tingkat Provinsi
          </h1>
          <p class="mb-4 text-sm font-medium text-gray-500">
            28 Agustus 2025 — Kelas 8B
          </p>
          <p class="leading-relaxed text-gray-700">
            Siswa berbakat dari kelas 8B berhasil meraih juara 2 dalam lomba menyanyi tingkat provinsi.
            Dengan suara merdu dan penampilan penuh percaya diri, ia memukau para juri dan penonton. 
            Keberhasilan ini menjadi kebanggaan sekolah serta inspirasi bagi siswa lain untuk menyalurkan bakat dan potensi mereka di bidang seni.
          </p>
        </div>
      </div>
    </div>
