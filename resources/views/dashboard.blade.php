...
<body class="bg-gray-50">
    <div class="flex h-screen">
        {{-- Sidebar --}}
<div class="sidebar bg-white shadow-lg flex flex-col items-start py-6 px-4 w-20 hover:w-60 transition-all duration-300">
    @include('dashboard.sidebar') <!-- Sudah termasuk logo, menu, dan logout -->
        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 p-8 overflow-auto relative">
                ...
                <button type="submit" class="absolute bottom-4 right-4 px-4 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700"></button>
            </main>
        </div>
    </div>
